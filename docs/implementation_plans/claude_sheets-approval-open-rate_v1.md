...
Branch: `claude/sheets-approval-open-rate` — v1 (2026-08-29)
...
relay, with the URL embedded — "FGAC is blocking this until you approve it —
one click, and you can revoke it any time from your dashboard: <url>". This
