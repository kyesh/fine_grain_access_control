# Drive file id hardening: never mint an approval link for an id Google cannot verify (v2)
...
**Preview:** same matrix against the preview URL — results recorded in the PR
hand-back (see PR #129 conversation).
