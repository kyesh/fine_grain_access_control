...
1. `docs/QA_Acceptance_Test/production/00_smoke_test.md`
2. `docs/QA_Acceptance_Test/production/01_hosted_mcp.md`
3. `docs/QA_Acceptance_Test/production/02_claude_code_mcp.md`
4. `docs/QA_Acceptance_Test/production/03_claude_code_cli.md`
5. `docs/QA_Acceptance_Test/production/04_openclaw.md`

Each doc installs from the real distribution channel for that agent,
...
| `/qa-claude-code-cli` | All capabilities pass via local scripts (auth.js, gmail.js) |
| `/qa-openclaw` | All capabilities pass via genuine OpenClaw Docker gateway |
| `/qa-production` | All 4 agents installed from real channels, all caps against `fgac.ai` |
