...
check $G ALLOW "vercel ls --prod"         "npx vercel ls fine-grain-access-control --prod"
check $G ALLOW "vercel logs --prod"       "npx vercel logs fine-grain-access-control --prod"
