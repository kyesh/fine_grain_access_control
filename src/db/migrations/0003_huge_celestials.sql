...
--> statement-breakpoint
ALTER TABLE "users" DROP CONSTRAINT "users_proxy_key_unique";
--> statement-breakpoint
ALTER TABLE "access_rules" ADD COLUMN "target_email" text;
--> statement-breakpoint
ALTER TABLE "email_delegations" ADD CONSTRAINT "email_delegations_owner_user_id_users_id_fk" FOREIGN KEY ("owner_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
ALTER TABLE "email_delegations" ADD CONSTRAINT "email_delegations_delegate_user_id_users_id_fk" FOREIGN KEY ("delegate_user_id") REFERENCES "public"."users"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
ALTER TABLE "key_email_access" ADD CONSTRAINT "key_email_access_delegation_id_email_delegations_id_fk" FOREIGN KEY ("delegation_id") REFERENCES "public"."email_delegations"("id") ON DELETE cascade ON UPDATE no action;
--> statement-breakpoint
...
--> statement-breakpoint
CREATE UNIQUE INDEX "delegation_unique" ON "email_delegations" USING btree ("owner_user_id","delegate_user_id");
--> statement-breakpoint
CREATE UNIQUE INDEX "key_email_unique" ON "key_email_access" USING btree ("proxy_key_id","target_email");
--> statement-breakpoint
